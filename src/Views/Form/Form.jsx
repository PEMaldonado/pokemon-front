...
const Form = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://pokemon-back-v6vx.onrender.com/pokemons",
        form
      );
  ...
  const handleCheck = (event) => {
    if (poketypes.type1 !== "" && poketypes.type2 !== "")
      setForm({ ...form, types: [poketypes.type1, poketypes.type2] });
    if (poketypes.type1 !== "" && poketypes.type2 === "")
      setForm({ ...form, types: [poketypes.type1] });
    if (poketypes.type1 === "" && poketypes.type2 !== "")
      setForm({ ...form, types: [poketypes.type2] });
    ...
    <div className={style.formContainer}>
      <form onSubmit={handleSubmit} className={style.form}>
        <div className={style.containers}>
          <label htmlFor="" className={style.labelName}>
            NAME{" "}
          </label>
          <input
        ...
        {showCheckbox && (
          <div className={style.checkbox}>
            <label htmlFor="">CONFIRM TYPES</label>
        ...
        <div className={style.buttonDiv}>
          <button type="submit" disabled={letcreate}>
            CREATE POKEMON
          </button>
        </div>
      </form>
